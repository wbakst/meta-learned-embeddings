...
class Sst2Processor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        """Added for sake of test set evaluation"""
        return self._create_examples(
...
def main():
    ...
    for train_dir in TRAIN_DIRS:
        ...
        # Prepare optimizer
        if args.do_train and train_dir_counter == 1:
            ...
            for dev_dir in DEV_DIRS:
                if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                    ...
                    with open(output_eval_file, "a") as writer:
                        ...
                        writer.write('dev_set -> train_dir_counter: ' + str(train_dir_counter) + ' dir: ' + dev_dir + '\n')
        ...
        if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0) and train_dir_counter == len(TRAIN_DIRS):
            ...
            if train_dir_counter == len(TRAIN_DIRS):
                model = BertForSequenceClassification.from_pretrained(args.bert_model, num_labels=num_labels)
        model.to(device)

        ### START OF TEST SET RESULTS ##
        for test_dir in TEST_DIRS:
            ...
            with open(output_eval_file, "a") as writer:
                writer.write('test_set ->  dir: ' + test_dir + '\n')
